...
foreach($adventurers as $adventurer){
	...
	echo '<table class="adventurer"><tr><th class="collected'.$adventurer['collected'].'">'.$adventurer['name'].'</th></tr><tr><td class="icon '.$adventurer['element'].' rank'.$adventurer['newrank'].'" style="background-image: url(\''.$image_url.'\');"></td></tr></table>';
