...
foreach($adventurers as $adventurer){
	...
	echo '<table class="adventurer"><tr><th class="'.$adventurer['collected'].'">'.$adventurer['name'].'</th></tr><tr><td class="icon '.$adventurer['element'].' rank'.$adventurer['newrank'].'"><img src="'.$image_url.'" /></td></tr></table>';
